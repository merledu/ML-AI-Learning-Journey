...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        is_knowledge_change=True

        while is_knowledge_change:
            is_knowledge_change=False
            ...
            for sentence_1 in self.knowledge:
                for sentence_2 in self.knowledge:
                    ...
                    if sentence_1.cells == set() and sentence_1.count > 0:
                        print('Error - sentence with no cells')
                        raise ValueError
                    ...
                    if sentence_1.cells.issubset(sentence_2.cells):
                        ...
                        if new_sentence not in self.knowledge:
                            ...
                            print('New Knowledge: ', new_sentence, 'from', sentence_1, ' and ', sentence_2)
                            self.knowledge.append(new_sentence)

      
        print('Current KB length: ', len(self.knowledge))
        print('Mines Known are : ', self.mines)
        ...
        if moves and not self.knowledge:
            ...
            for sentence in self.knowledge:
                ...
                for cell in sentence.cells:
                    is_key = moves.get(cell)
                    if is_key and moves[cell] < mine_prob:
